...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey }, "v", function () awful.util.spawn_with_shell("clipmenu") end,
              {description = "clipboard history by rofi/clipmenud", group = "awesome"}),
  awful.key({modkey}, "l", function()
  awful.spawn('rofi -show-icons -modi windowcd,window,drun -show window')end, 
    {description="show client list", group = "awesome"}),
  awful.key({modkey}, ",", function()
  awful.spawn('rofimoji') end,
    {description="show emojis", group = "awesome"}),
    ...
    awful.key({ modkey }, "space", function () awful.util.spawn_with_shell("kitty") end,
...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule {
	rule_any = {
           name = { "Firefox", "Brave", "Firefox Developer Edition" }
	},
