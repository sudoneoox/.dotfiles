...
local wppath                = os.getenv("HOME") .. "/Pictures/wallpapers/"
local wppath_user           = os.getenv("HOME") .. "/Pictures/wallpapers/"
local wppath_colorscheme    = os.getenv("HOME") .. "/Pictures/public-wallpapers/colorscheme/" .. theme.scheme_id .. "/"
...
local tempWibox = wiboxBox2(tempicon, tempcpu.widget, NULL, wboxColor, theme.widgetbar_fg, 4, 4, underLineSize,
    wiboxMargin)
...
-- brightness widget
wboxColor = theme.baseColors[2]
local brightWibox = wiboxBox1(nil, brightness_widget {
    type = 'arc',
